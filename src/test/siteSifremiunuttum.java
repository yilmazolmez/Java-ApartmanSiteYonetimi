...
public class siteSifremiunuttum extends JDialog {
	...
	public siteSifremiunuttum() {
		...
		soruyubul.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Connection myconn=DriverManager.getConnection ("jdbc:mysql://"+siteLoginForm.loginsunucu+"/hukukburosu?useTimezone=true&serverTimezone=UTC","root","");
