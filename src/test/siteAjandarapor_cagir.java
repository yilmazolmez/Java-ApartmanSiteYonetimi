...
public class siteAjandarapor_cagir {
	...
	public void rapor(String sayi) {
		...
		try 
		{
			...
			String listele="Select * From siteajanda where islemid='"+sayi+"'";
			...
			rs1=mystat1.executeQuery(listele);
				...
				{	
					...
					PdfWriter pdfWriter = PdfWriter.getInstance(document, new FileOutputStream(path+"\\siteajanda.pdf"));
					document.open();
			       ...
			       // String FILE = "C:\\Users\\yýlmaz\\eclipse-workspace\\Deneme\\avukatbilgi.pdf";
			        String FILE = path+"\\siteajanda.pdf";
					try 
					{
